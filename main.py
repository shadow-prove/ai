...
BOT_TOKEN = "6712172523:AAGZiLoTBWBcskAvwUVay4cGdWnUh6wmRE4"

loaded_model = tf.keras.models.load_model("custom_cnn_cifar10_model.h5")
...
async def get_photo(message: Message, bot: Bot):
    ...
    await bot.download_file(image.file_path, "image.jpg")

    img_array = preprocess_image("image.jpg")
